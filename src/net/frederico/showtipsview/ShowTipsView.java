...
public class ShowTipsView extends RelativeLayout {
	...
	public void show(final Activity activity) {
		...
		new Handler().postDelayed(new Runnable() {
			...
			public void run() {
				...
				Animation fadeInAnimation = AnimationUtils.loadAnimation(getContext(), R.animator.fade_in);
	...
	private TextView textTitle=null,text=null;
	...
	private void createViews() {
		if(textTitle!=null&&text!=null&&btn_close!=null&&!configChange){
			this.removeAllViews();
			textTitle=null;text=null;btn_close=null;
		}
